...
export default function About() {
  return (
    <main className="split-story about-story">
      <StoreImage src="/images/wedding_picture.JPG" alt="Anna Love, the heart and hands behind Love & Co." />
      <div>
        <p className="eyebrow">ABOUT</p>
        <h1>Hi there, I’m Anna</h1>
        <p>The heart and hands behind Love & Co. Embroidery.</p>
